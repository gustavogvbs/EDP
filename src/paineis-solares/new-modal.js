...
document.querySelectorAll(".cta-button-simular").forEach((item) => {
    ...
    <div id="moradia-step" class="fixed w-full h-full z-10 top-0 left-0 hidden bg-[#f1f4f4] data-[status=open]:block">
      <iframe
        src="https://www.edp.pt/solar-single-page/?modal=modal33575${
					params.search.length > 0 ? "&".concat(params.search.slice(1)) : ""
				}"
